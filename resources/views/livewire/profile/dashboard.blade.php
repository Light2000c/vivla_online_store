                         ...
                         <div class="tab-content">
                             <div class="tab-pane fade show active" id="nav-dashboard" role="tabpanel">
                                 <div class="axil-dashboard-overview">
                                     <div class="welcome-text">Hello {{ Auth::user()->name }} (not <span
                                             class="ms-2">{{ Auth::user()->name }}?</span> <a href="sign-in.html">Log
                                             Out</a>)</div>
                                     <p>From your account dashboard you can view your recent orders, manage your billing
                             ...
                             <div class="tab-pane fade" id="nav-address" role="tabpanel">
                                 <div class="axil-dashboard-address">
                                     <p class="notice-text">The following addresses will be used on the checkout page by
                                         default. You can select different billing or shipping addresses during checkout
                                         or update them in your account settings if needed.</p>
                                     <livewire:components.address />
                                 </div>
                             </div>
                             <div class="tab-pane fade" id="nav-account" role="tabpanel">
                                 <div class="col-lg-9">
                                     <p class="notice-text">Update your personal information, including your name,
                                         email, and other details. Keep your profile up-to-date to ensure accurate
                                         communication and seamless service.</p>
