                    ...
                    <div class="left-menu-header">
                        ...
                        <ul class="header-left">
                            <li class="onhover-dropdown"><span class="f-w-500">
                                    <svg>
                                        <use href="/web1/assets/svg/icon-sprite.svg#fill-bonus"></use>
                                    </svg>Bonus Ui</span>
                                <ul class="onhover-show-div left-dropdown">
                            ...
                            <li class="onhover-dropdown"><span class="f-w-500">
                                    <svg>
                                        <use href="/web1/assets/svg/icon-sprite.svg#fill-Grid"></use>
                                    </svg>Level Menu</span>
                                <ul class="onhover-show-div left-dropdown">
                            ...
                            <li class="onhover-dropdown"> <span class="f-w-500">
                                    <svg>
                                        <use href="/web1/assets/svg/icon-sprite.svg#fill-Perk-Ui"></use>
                                    </svg>Project</span>
                                <ul class="onhover-show-div left-dropdown">
                    ...
                    <ul class="nav-menus">
                        ...
                        <li class="onhover-dropdown">
                            <div class="notification-box">
                                <svg>
                                    <use href="/web1/assets/svg/icon-sprite.svg#fill-Bell"></use>
                                </svg>
                            </div>
                        ...
                        <li class="onhover-dropdown">
                            <svg>
                                <use href="/web1/assets/svg/icon-sprite.svg#fill-star"></use>
                            </svg>
                        ...
                        <li class="cart-nav onhover-dropdown">
                            <div class="cart-box">
                                <svg>
                                    <use href="/web1/assets/svg/icon-sprite.svg#fill-Buy"></use>
                                </svg>
                            </div>
                                ...
                                <ul>
                                    <li>
                                        <div class="d-flex"><img class="img-fluid b-r-5 img-60"
                                                src="/web1/assets/images/ecommerce/06.jpg" alt="">
                                    ...
                                    <li>
                                        <div class="d-flex"><img class="img-fluid b-r-5 img-60"
                                                src="/web1/assets/images/ecommerce/02.jpg" alt="">
                                    ...
                                    <li><a class="view-cart" href="cart.html">View Cart</a><a
                                            class="view-checkout f-right" href="checkout.html">Checkout</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="onhover-dropdown">
                            <div class="message">
                                <svg>
                                    <use href="/web1/assets/svg/icon-sprite.svg#fill-message"></use>
                            ...
                            <div class="onhover-show-div message-dropdown">
                                ...
                                <ul>
                                    <li>
                                        <div class="d-flex align-items-start">
                                            <div class="message-img bg-light-primary"><img
                                                    src="/web1/assets/images/user/3.jpg" alt=""></div>
                                    ...
                                    <li>
                                        <div class="d-flex align-items-start">
                                            <div class="message-img bg-light-primary"><img
                                                    src="/web1/assets/images/user/6.jpg" alt=""></div>
                                            <div class="flex-grow-1">
                                    ...
                                    <li>
                                        <div class="d-flex align-items-start">
                                            <div class="message-img bg-light-primary"><img
                                                    src="/web1/assets/images/user/10.jpg" alt=""></div>
                                            <div class="flex-grow-1">
                        ...
                        <li>
                            <div class="mode">
                                <svg>
                                    <use href="/web1/assets/svg/icon-sprite.svg#fill-dark"></use>
                                </svg>
                            </div>
                        </li>
                        <li class="profile-nav onhover-dropdown p-0">
                            <div class="d-flex align-items-center profile-media"><img class="b-r-10 img-40"
                                    src="/web1/assets/images/dashboard/profile.png" alt="">
