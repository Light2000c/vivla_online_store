...
<body>
    <div class="container">
      <div class="row d-flex justify-content-center mb-5 mt-5">
        <div class="col-11 col-lg-9 mt-5">
            <div style="text-align: center;">
                <h3> Error Message!</h3>
                <p>Oops! Something went wrong while processing your payment. Your order couldn't be completed due to a technical issue. Please check your payment status, and if you're charged, kindly contact our support team for assistance. Otherwise, you may try again. We apologize for the inconvenience.</p>
                <div>
