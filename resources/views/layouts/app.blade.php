                            ...
                            <nav class="department-nav-menu">
                                ...
                                <ul class="nav-menu-list">
                                    <li>
                                        <a href="#" class="nav-link has-megamenu">
                                            <span class="menu-icon"><img
                                                    src="/web/assets/images/product/categories/cat-01.png"
                                                    alt="Department"></span>
                                                ...
                                                <div class="featured-product">
                                                    ...
                                                    <div class="product-list">
                                                        <div class="item-product">
                                                            <a href="#"><img
                                                                    src="/web/assets/images/product/product-feature1.png"
                                                                    alt="Featured Product"></a>
                                                        </div>
                                                        <div class="item-product">
                                                            <a href="#"><img
                                                                    src="/web/assets/images/product/product-feature2.png"
                                                                    alt="Featured Product"></a>
                                                        </div>
                                                        <div class="item-product">
                                                            <a href="#"><img
                                                                    src="/web/assets/images/product/product-feature3.png"
                                                                    alt="Featured Product"></a>
                                                        </div>
                                                        <div class="item-product">
                                                            <a href="#"><img
                                                                    src="/web/assets/images/product/product-feature4.png"
                                                                    alt="Featured Product"></a>
                                                        </div>
                                                    </div>
                                                    <a href="#" class="axil-btn btn-bg-primary">See All
                                                        Offers</a>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <li>
                                        <a href="#" class="nav-link has-megamenu">
                                            <span class="menu-icon"><img
                                                    src="/web/assets/images/product/categories/cat-02.png"
                                                    alt="Department"></span>
                                    ...
                                    <li>
                                        <a href="#" class="nav-link has-megamenu">
                                            <span class="menu-icon"><img
                                                    src="/web/assets/images/product/categories/cat-03.png"
                                                    alt="Department"></span>
                                    ...
                                    <li>
                                        <a href="#" class="nav-link">
                                            <span class="menu-icon"><img
                                                    src="/web/assets/images/product/categories/cat-04.png"
                                                    alt="Department"></span>
                                    ...
                                    <li>
                                        <a href="#" class="nav-link">
                                            <span class="menu-icon"><img
                                                    src="/web/assets/images/product/categories/cat-05.png"
                                                    alt="Department"></span>
                                    ...
                                    <li>
                                        <a href="#" class="nav-link">
                                            <span class="menu-icon"><img
                                                    src="/web/assets/images/product/categories/cat-06.png"
                                                    alt="Department"></span>
                                    ...
                                    <li>
                                        <a href="#" class="nav-link">
                                            <span class="menu-icon"><img
                                                    src="/web/assets/images/product/categories/cat-07.png"
                                                    alt="Department"></span>
                                    ...
                                    <li>
                                        <a href="#" class="nav-link">
                                            <span class="menu-icon"><img
                                                    src="/web/assets/images/product/categories/cat-08.png"
                                                    alt="Department"></span>
                    ...
                    <li class="cart-item">
                        <div class="item-img">
                            <a href="single-product.html"><img
                                    src="/web/assets/images/product/electric/product-01.png"
                    ...
                    <li class="cart-item">
                        <div class="item-img">
                            <a href="single-product-2.html"><img
                                    src="/web/assets/images/product/electric/product-02.png"
                                    alt="Commodo Blown Lamp"></a>
                            <button class="close-btn"><i class="fas fa-times"></i></button>
                        </div>
                        <div class="item-content">
                    ...
                    <li class="cart-item">
                        <div class="item-img">
                            <a href="single-product-3.html"><img
                                    src="/web/assets/images/product/electric/product-03.png"
                                    alt="Commodo Blown Lamp"></a>
                            <button class="close-btn"><i class="fas fa-times"></i></button>
                        </div>
                        <div class="item-content">
