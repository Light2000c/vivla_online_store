...
use App\Models\GuestPayment as ModelsGuestPayment;
...
class GuestPayment extends Component
{
    ...
    {
        $this->load();
        return view('livewire.admin.guest-payment',[
    ...
    public function load()
    {
        ...
        if (!$this->search) {
            $this->payments = ModelsGuestPayment::orderBy('created_at', 'DESC')->paginate(3);
        } else {
            $this->payments = ModelsGuestPayment::whereHas('user', function ($query) use ($searchTerm) {
    ...
    public function delete($id)
    {
        ...
        try {
            ...
            $payment = ModelsGuestPayment::find($id);
    ...
    public function deleteSelected()
    {
        ...
        try {
            ...
            $delete = ModelsGuestPayment::whereIn("id", $this->selectedItems)->delete();
