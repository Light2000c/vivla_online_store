                            ...
                            <tbody>
                                @if ($transactions->count())
                                    @foreach ($transactions as $order)
                                        <tr>
                                            <th> <input class="form-check-input" wire:model="selectedItems"
                                                    type="checkbox" id="checkbox-{{ $order->id }}"
                                                    value="{{ $order->id }}"></th>
                                            ...
                                            <td>
                                                <a href="{{ route('admin-guest-order', $order->reference) }}"
                                                    class="btn btn-outline-primary btn-sm mb-1" type="submit"><i
                                                        class="bi bi-eye"></i></a>
                                                <a wire:click="openUpdateModal({{ $order->id }})"
                                                    class="btn btn-outline-primary btn-sm mb-1" type="submit"><i
                                                        class="bi bi-pencil-square"></i></a>
                                                <button wire:click="delete({{ $order->id }})"
                                                    class="btn btn-danger btn-sm mb-1" type="submit"
